    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex gap-2">
                <div class="mb-3">
                    <a href="{{ route('lecturers.create') }}" class="btn btn-primary">Add New Lecturer</a>
                </div>
                <div class="mb-3">
                        ...
                        <form action="{{ route('lecturers.import') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="uploadBatchModalLabel">Upload Batch Lecturers</h5>
                                    <button type="button" class="btn-close" data-coreui-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <a href="{{ asset('documents/lecturers_template.xlsx') }}">
                                            Download Template
                                        </a>
                                    </div>
                                    <div class="mb-3">
