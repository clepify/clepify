<a class="btn btn-sm btn-warning dropdown rounded" href="{{ route('lecturers.edit', $id) }}">
...
<form id="delete-{{ $id }}" class="d-none" action="{{ route('lecturers.destroy', $id) }}" method="POST">
    @csrf
    @method('DELETE')
</form>
